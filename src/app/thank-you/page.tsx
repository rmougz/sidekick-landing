...
export const metadata: Metadata = {
  ...
  description: "Your Agency Profit Audit is confirmed. We look forward to speaking with you.",
};
      ...
      <section className="flex min-h-screen flex-col items-center justify-center px-5 py-20 text-center">
        <div className="mx-auto max-w-[600px]">
          ...
          <p className="mb-3 text-lg leading-relaxed text-sk-text max-sm:text-base">
            Thanks for booking your Agency Profit Audit. Check your inbox for the calendar invite and any prep details.
          </p>
